...
step1, step2, LOCATION, BIO = range(4)
...
def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            step1: [MessageHandler(filters.Regex("^(Sativa|Indika|Hash)$"), typeof)],
            step2: [MessageHandler(filters.Regex("^(1|2|5)$"), weight), CommandHandler("skip", skip_photo)],
            LOCATION: [
